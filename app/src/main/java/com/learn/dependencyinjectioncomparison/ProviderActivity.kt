...
import com.learn.dependencyinjectioncomparison.modules.ProviderBagOfDependencies
import com.learn.dependencyinjectioncomparison.modules.kodeinProviderBagOfDependencies
import com.learn.dependencyinjectioncomparison.modules.koinFactoryBagOfDependencies
 ...
 */
class ProviderActivity : AppCompatActivity(), KodeinAware {

    override val kodein = Kodein {
        import(kodeinProviderBagOfDependencies, true)
    }

    @Inject
    lateinit var daggerControlled: ControlOverConstructor
    @Inject
    lateinit
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        DaggerProviderActivity_ComponentDefinedInActivity.create().giveMeMyDependencies(this)

        //NOTE: if you go back to the SingletonActivity now this module is still loaded
        loadKoinModules(koinFactoryBagOfDependencies)
    ...
    @Component(modules = [ProviderBagOfDependencies::class])
    interface ComponentDefinedInActivity {
        fun giveMeMyDependencies(app: ProviderActivity)
    }
}
